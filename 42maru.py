...
# print(solution("블라인드 20%정도 열어줘, 그저께 산 커튼은 30퍼센트 정도 열어줘, 영화 11화는 2프로정도 다운로드 됐나?"))

print(solution("2018년 1월 15일에 보낸 메일 찾아줘 어제 본 드라마 11회는 50퍼센트 정도 다운됐어"))

print(solution("2018년 1월 15일에 보낸 메일 찾아줘"))

print(solution("1996년생 운세 알려줘"))

print(solution("1990년대 발라드 틀어줘"))

print(solution("멜론 차트 10위부터 틀어줘"))

print(solution("1m 간격으로 앉으세요"))

print(solution("서울의 면적은 605.2km²입니다"))

print(solution("거실 난방 20도 맞춰줘"))
